...
const Generate = () => {
  ...
  const handleGenerate = async () => {
    if (!isLoggedIn) return toast.error("pls login to generate thumbnails");
    if (!title.trim()) return toast.error("pls give the title");
    setloading(true);
    setThumbnail(null)
    const apiPayload = {
      title,
                ...
                <div className="space-y-5">
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      rows={3}
                      placeholder="Add any specific elements ,mood ,style preferences ..."
